...
public partial class ModelContainer : DbContext
{
    ...
    public virtual DbSet<SW_role_claims> SW_role_claims { get; set; }

    public virtual DbSet<SW_user_claims> SW_user_claims { get; set; }

    public virtual DbSet<SW_user_logins> SW_user_logins { get; set; }

    public virtual DbSet<SW_user_tokens> SW_user_tokens { get; set; }
    ...
    public virtual DbSet<SW_beneficiary> SW_beneficiary { get; set; }

    public virtual DbSet<SW_financial_institution> SW_financial_institution { get; set; }

    public virtual DbSet<SW_organization> SW_organization { get; set; }
