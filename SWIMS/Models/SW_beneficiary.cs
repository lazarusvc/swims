...
public static class SW_beneficiaryEndpoints
{
    public static void MapSW_beneficiaryEndpoints (this IEndpointRouteBuilder routes)
    {
        ...
        group.MapGet("/{id}", async Task<Results<Ok<SW_beneficiary>, NotFound>> (HttpContext http, int id, SwimsDb_moreContext db) =>
        {
        ...
        group.MapPut("/{id}", async Task<Results<Ok, NotFound>> (HttpContext http, int id, SW_beneficiary sW_beneficiary, SwimsDb_moreContext db) =>
        {
        ...
        group.MapPost("/", async (HttpContext http, SW_beneficiary sW_beneficiary, SwimsDb_moreContext db) =>
        {
