...
public static class SW_financial_institutionEndpoints
{
    ...
    public static void MapSW_financial_institutionEndpoints (this IEndpointRouteBuilder routes)
    {
        ...
        group.MapPut("/{id}", async Task<Results<Ok, NotFound>> (HttpContext http, int id, SW_financial_institution sW_financial_institution, SwimsDb_moreContext db) =>
        {
        ...
        group.MapPost("/", async (HttpContext http, SW_financial_institution sW_financial_institution, SwimsDb_moreContext db) =>
        {
